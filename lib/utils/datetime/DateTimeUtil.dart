// ignore_for_file: file_names, parameter_assignments
...
class DateTimeUtil {
  ...
  static String? getDateTimeSendServer(String dateTimeString) {
    final dateTime = stringToDateTime(dateTimeString, 'HH:mm dd-MM-yyyy');
    return dateTimeToString(dateTime, "yyyy-MM-dd'T'HH:mm:ss.SSS");
  }
  ...
  static String? getDateTimeTHG(String? dateTimeString) {
    ...
    final dateTime = stringToDateTime(dateTimeString, "yyyy-MM-dd'T'HH:mm:ss");
